	...
	<div class="center-align">
		<form name="formm" method="post">
			...
			<table id="cartList">
				...
				<tr>
					<td colspan="4">배송지 : ${orderDetail.ADDRESS1}
						${orderDetail.ADDRESS2} ${orderDetail.ADDRESS3}</td>
				</tr>
			</table>
			<h3>주문 상품 정보</h3>
			<table id="cartList">
				...
				<c:forEach items="${orderList}" var="orderVO">
					<tr>
						...
						<td><c:choose>
								...
								<c:otherwise>
									<span style="color: red; font-weight: bold;"> 구매확정 </span>
								</c:otherwise>
							</c:choose></td>
					</tr>
				</c:forEach>
