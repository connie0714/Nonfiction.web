...
<form name="frm" method="get">
	...
	<table id="orderList" align="center">
		...
		<c:forEach items="${orderList}" var="orderVO">
			<tr>
				...
				<td>${orderVO.MNAME}(${orderVO.USERID})</td><td>${orderVO.PNAME}</td><td>${orderVO.QUANTITY}</td>
	...
	<div class="clear"></div>
	<input type="button" class="btn" style="width: 200px" value="다음단계로" onClick="go_order_update()">
</form><br>
