...
public class CustomerService {
	...
	public HashMap<String, Object> getFaqList(HttpServletRequest request) {
		HashMap<String, Object> paramMap = new HashMap<String, Object>();
	     HttpSession session = request.getSession();
	...
	public void getFaq(HashMap<String, Object> paramMap) {
		cdao.getFaq(paramMap);
